...
//   private _store: any;
//   private entityIndex: N3EntityIndex;
...
//     this._store = store;
//     this.entityIndex = store._entityIndex;
//   }

//   _add(subject: number, predicate: number, object: number, graphItem, cb: () => void) {
...
//   _evaluateRules(rules, content, cb: () => void) {
...
//       { value: this.entityIndex.termToId(value) };
...
// function getIndex({ subject, predicate, object }: VariableQuad, set: Set<VariableTerm>) {
...
// interface VariableQuad {
//   subject: VariableTerm;
//   predicate: VariableTerm;
//   object: VariableTerm;
// }

// function termEq(t1: VariableTerm, t2: VariableTerm) {
//   if (t1.value === null) {
//     t1.value = t2.value;
//     // TODO: See if a 'return true' improves efficiency here
//   }
